                ...
                <form class="form" action="/orders" method="post">
                    ...
                    <div class="form-group">
                        <div class="input-group dates-wrap">
                            <input id="datepicker2" class="dates form-control" placeholder="Date" type="date"
                                   name="date">
                    ...
                    <div class="form-group">
                        <button class="btn btn-default btn-lg btn-block text-center text-uppercase">Make reservation
                        </button>
